...
enum RouterVersion {
  BeefswapV2Router01 = 'BeefswapV2Router01',
  BeefswapV2Router02 = 'BeefswapV2Router02'
}

describe('BeefswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.BeefswapV2Router01]: fixture.router01,
        [RouterVersion.BeefswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.BeefswapV2Router01]: 101876,
              [RouterVersion.BeefswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.BeefswapV2Router01]: 138770,
              [RouterVersion.BeefswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
